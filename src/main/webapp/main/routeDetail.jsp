		...
		<div class="card">
			<div class="infoCard">
				...
				<div class="col-md-7">
					<div class="cardBody">
						<h6 class="card-title">
							빨강 홀드 남색 레벨 <small class="small-txt">문제 아이디 16531</small>
						</h6>
						<ul id="detail-info">
							<li><span class="bold">섹터</span>미드나잇 (2022.05.02 ~
								2022.06.02)</li>
							<li><span class="bold">맵기</span>
								<div class="score-container">
									<div class="progress">
										<div class="progress-bar bg-danger gradient-level"
											role="progressbar" style="width: 70%" aria-valuenow="25"
											aria-valuemin="0" aria-valuemax="100"></div>
									</div>
								</div></li>
							<li><span class="bold">재미</span>
								<div class="score-container">
									<div class="progress">
										<div class="progress-bar bg-warning gradient-fun"
				...
				<div class="col-md-2 side-info">
					<p class="x-small gray">
						조회수<span>56</span>
					</p>
					<p class="x-small gray">
						<i class="bi bi-heart"></i> 좋아요 <span>15</span>
					</p>
				</div>
			</div>
		</div>
